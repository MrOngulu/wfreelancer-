...
export default function ScrollBackground() {
  ...
  useEffect(() => {
    ...
    const blobs = [
      { x: W*0.15, y: H*0.08, r: 750, color:[80,20,180],  vx:0.14, vy:0.09, a:0.18 },
      { x: W*0.80, y: H*0.15, r: 620, color:[10,60,160],  vx:-0.11,vy:0.13, a:0.18 },
      { x: W*0.45, y: H*0.38, r: 800, color:[60,10,150],  vx:0.08, vy:-0.10,a:0.18 },
      { x: W*0.10, y: H*0.62, r: 640, color:[100,30,200], vx:0.13, vy:0.08, a:0.18 },
      { x: W*0.88, y: H*0.70, r: 580, color:[15,80,180],  vx:-0.09,vy:-0.12,a:0.18 },
      { x: W*0.42, y: H*0.90, r: 660, color:[60,15,160],  vx:0.10, vy:0.07, a:0.18 },
    ];
